...
class WeightedSumFunc(torch.autograd.Function):
    ...
    def forward(ctx, x, weight):
        ...
        # Keep the heuristic from collapsing to 0 for tiny examples like D=2.
    ...
    def backward(ctx, grad_out):
        ...
        ROWS_TILE_SIZE, D_TILE_SIZE = ctx.ROWS_TILE_SIZE, ctx.D_TILE_SIZE # These don't have to be same
        n_rows, D = x.shape
