...
if __name__ == "__main__":
    ...
    # [timing_summary world size 2] global_avg_step_time = 7.1030s, global_avg_grad_comm_time = 0.2831s, global_grad_comm_pct = 3.99%
    # [timing_summary world size 4] global_avg_step_time = 18.1306s, global_avg_grad_comm_time = 0.6411s, global_grad_comm_pct = 3.54%
